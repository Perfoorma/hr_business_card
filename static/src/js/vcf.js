...
VERSION:3.0
N;CHARSET=UTF-8:${vcf_lastname.value};${vcf_firstname.value}
FN;CHARSET=UTF-8:${vcf_firstname.value} ${vcf_lastname.value}
TEL;WORK:${vcf_phone.value}
ADR;CHARSET=UTF-8;WORK:;;${vcf_street.value} ${vcf_street.value};${vcf_city.value};${vcf_state.value};${vcf_zip.value};${vcf_country.value}
